...
interface ApiService {
    ...
    @POST("upload/{id}")
    fun enviarImagemParaProduto(@Path("id") idDoProduto: Int, @Body imagem: RequestBody): Call<ResponseBody>
    ...
    @GET("upload/{id}")
    fun obterImagemPorIdDoProduto(@Path("id") idDoProduto: Int): Call<ResponseBody>
